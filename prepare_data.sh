...
if [ ! -d clean_trainset_wav_16k ]; then
    ...
    if [ ! -f clean_trainset_wav.zip ]; then
        ...
        wget https://datashare.is.ed.ac.uk/bitstream/handle/10283/2791/clean_trainset_56spk_wav.zip
    fi
...
if [ ! -d noisy_trainset_wav_16k ]; then
    ...
    if [ ! -f noisy_trainset_wav.zip ]; then
        ...
        wget https://datashare.is.ed.ac.uk/bitstream/handle/10283/2791/noisy_trainset_56spk_wav.zip
    fi
